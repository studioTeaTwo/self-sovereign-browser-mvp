// TODO: (ssb) migrate to toolkit to share among about/extenstion and browser/mobile.
// ref: https://github.com/getAlby/lightning-browser-extension/blob/master/src/extension/background-script/connectors/lnc.ts
